...
export default function Home() {
  ...
  const optionStyles =
    "flex justify-between items-center gap-2 xs:gap-6 w-64 xs:w-80 text-sm xs:text-md bg-neutral-300 dark:bg-neutral-800 p-2 rounded-lg font-medium xs:font-semibold text-neutral-800 dark:text-neutral-100";
  ...
  return (
    <div className="min-h-full min-w-full py-6 xs:py-10 flex flex-col items-center justify-between">
      <form
      ...
      >
        ...
        <div
          className={
            "flex justify-between items-center gap-2 w-64 xs:w-80 text-sm xs:text-md bg-neutral-300 dark:bg-neutral-800 p-2 rounded-lg font-medium xs:font-semibold text-neutral-800 dark:text-neutral-100"
          }
        >
          <span>4</span>
          <input
        ...
        <button
          className={`flex items-center justify-center max-h-10 w-full mt-4 py-3 rounded-lg font-bold text-sm xs:text-md text-neutral-600 hover:text-neutral-100 dark:text-neutral-100 bg-neutral-300 hover:bg-neutral-400 dark:bg-neutral-800 hover:dark:bg-neutral-600 transition-colors duration-200 ${
